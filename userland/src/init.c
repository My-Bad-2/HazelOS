...
void user_start() {
    ...
    void* ptr  = mmap(nullptr, 0x4000, PROT_READ | PROT_WRITE, MAP_GROWSDOWN | MAP_PRIVATE, 0, 0);
    void* ptr2 = mmap(nullptr, 0x4000, PROT_READ | PROT_WRITE, MAP_GROWSDOWN | MAP_PRIVATE, 0, 0);
